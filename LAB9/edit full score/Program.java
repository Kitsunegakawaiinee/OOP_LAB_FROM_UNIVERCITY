        ...
        private void analys(String input)
        {
            ...
            try 
            {
                for(int i = 0; i<size; i++)
                {
                    ...
                    //first finding : thrown exception if start with operator (except -) or character
                    if(first_find)
                    {
                        if(temp == ' ') continue;
                    ...
                    if(find_int)
                    {
                        if(temp == ' ')
                        {
                            ...
                            {
                                data_int.add(Double.parseDouble(number)); //thrown - exception
                                number = "";
                                find_int = false;
                                operator_allow = true;
                            }
                ...
                while(!ope.isEmpty())
                {
                    ...
                    switch (operator) {
                        ...
                        case '%' ->
                        {
                            try 
                            {
                                if(temp == 0) throw new Exception("Something worng with this input (something%0)");
                                else
                                {
                                    ans %= temp;
                                }
